...
import (
	auth_store "GophKeeper/internal/storage/auth_store"
	reflect "reflect"
...
func (m *MockAuthStorage) Create(cred auth_store.Credential) error {
	m.ctrl.T.Helper()
...
func (m *MockAuthStorage) Find(email string) (auth_store.Credential, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Find", email)
	ret0, _ := ret[0].(auth_store.Credential)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
